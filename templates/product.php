        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              ...
              <a style="color: #FFF;" href="product_add.php"><div class="btn btn-info" style="margin: 5px 30px 5px;">
                 Add
              </div></a>
                 ...
                 else
                 {
                         ...
                         var tr = '';
                          $.each(result, function(index, item){
                                  tr += "<tr>\
                                             <td>"+item.name+"</td>\
                                             <td>"+item.product_uniform_name+"</td>\
                                             <td>"+item.product_type_name+"</td>\
                                             <td>"+item.quantity+"</td>\
                                             <td>"+item.description+"</td>\
                                             <td><a class='fa fa-fw fa-edit' href='product_edit.php?id="+item.id+"''></a>&nbsp;<a type='submit' class='glyphicon glyphicon-trash' data-toggle='modal' onclick=destroy("+item.id+") ></a></td>\
                                             </tr>";
                          });
                }
